...
//      internal class EditorStyleDrawerOLD : PropertyDrawer
//      {
...
//                              }
//                              else StyleRule.PropertyMapOLD.Where(option => (mask.intValue & option.Key) is not 0).ToList().ForEach(option =>
//                              {
...
//                              foreach (var option in StyleRule.PropertyMapOLD)
//                              {
...
//                              :
//                              StyleRule.PropertyMapOLD.Where(option => (maskValue & option.Key) != 0).Sum(option => EditorGUI.GetPropertyHeight(property.FindPropertyRelative(option.Value)) + standardVerticalSpacing); // - [ 5 ]
//                  }
//                  return value;
//            }
...
//            }
//      }
//}private void DrawArrayProperty(ref Rect position, SerializedProperty property)


//static void DrawArrayProperty(ref Rect position, SerializedProperty property)
//{
//      // Draw the array label as a boxed header
//      EditorGUI.LabelField(position, property.displayName, GUI.skin.box);
//      position.y += position.height + EditorGUIUtility.standardVerticalSpacing;

//      // Loop through array elements and draw each
//      for (int i = 0; i < property.arraySize; i++)
//      {
//            SerializedProperty element = property.GetArrayElementAtIndex(i);
//            Rect elementRect = new(position.x, position.y, position.width, EditorGUI.GetPropertyHeight(element));
//            EditorGUI.PropertyField(elementRect, element, GUIContent.none);
//            position.y += elementRect.height + EditorGUIUtility.standardVerticalSpacing;
//      }

//      // Draw control buttons for adding/removing elements
//      Rect buttonRect = new(position.x, position.y, position.width * 0.5f, EditorStyles.miniButton.fixedHeight);
//      if (GUI.Button(buttonRect, "+", EditorStyles.miniButtonLeft))
//      {
//            property.InsertArrayElementAtIndex(property.arraySize);
//      }

//      buttonRect.x += buttonRect.width;
//      if (GUI.Button(buttonRect, "-", EditorStyles.miniButtonRight) && property.arraySize > 1)
//      {
//            property.DeleteArrayElementAtIndex(property.arraySize - 1);
//      }
